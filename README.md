...
* Debe estar realizado en un framework de frontend, Angular o React (Preferentemente NextJS).
* La aplicación debe estar publicada y debe ser accesible mediante un link(Ver Netlify, Heroku) o cualquier webserver.
* El código de la aplicación debe estar subida a un repositorio de público acceso.# challenge-Esto-Es
